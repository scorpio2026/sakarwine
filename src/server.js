...
function startAiWelcome(user) {
  ...
  const hostNotice = [
    ...
    'အဆင့်မြှင့်သူများ ထိုကုဒ်ကို ထည့်ရန် မဖြစ်မနေ မဟုတ်။ မှန်ကန်သော ကုဒ်ဖြင့် အတည်ပြုသော အဆင့်မြှင့်တိုင်း host က လတစ်လလျှင် +၅၀၀ ရသည် (၁ လ → +၅၀၀၊ ၂ လ → +၁၀၀၀၊ ၆ လ → +၃၀၀၀၊ ၁၂ လ → +၆၀၀၀)။ စကားပြောချိန်ဖြင့် +၅၀၀ မရတော့ပါ။',
    ...
    'Members may optionally enter that code when upgrading. Each time a valid code is used on an approved upgrade, you earn +500 × months (1 month → +500, 2 months → +1000, 6 → +3000, 12 → +6000). Chat time no longer pays +500.',
